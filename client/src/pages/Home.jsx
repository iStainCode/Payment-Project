            ...
            <div className="container mx-auto flex flex-col items-center py-12 sm:py-24">
              <div className="w-11/12 sm:w-2/3 lg:flex justify-center items-center flex-col  mb-5 sm:mb-10">
                <motion.h1
                  ...
                  ref={ref}
                >
                  El mejor manejador de
                  <span className="text-indigo-700"> Deudas </span>y mejor
                  servicio
                </motion.h1>
                <motion.p
                ...
                >
                  A nivel de usuario nos guarta darle a nuestros usuario la
                  mejor calidad para poder una confianza como ninguna otra{" "}
                </motion.p>
              </div>
              <div className="flex justify-center items-center">
                <motion.button
                  ...
                  whileTap={{ scale: 0.9 }}
                  initial={{ scale: 0.5, opacity: 0, delay: 0.3, x: -900 }}
      ...
      <footer className="bg-gray-100">
        <div className="relative mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8 lg:pt-24">
          <div className="absolute end-4 top-4 sm:end-6 sm:top-6 lg:end-8 lg:top-8">
            <a
              className="inline-block rounded-full bg-indigo-700 p-2 text-white shadow transition hover:bg-indigo-600 sm:p-3 lg:p-4"
              href="#MainContent"
            >
          ...
          <div className="lg:flex lg:items-end lg:justify-between">
            <div>
              <div className="flex justify-center text-indigo-700 lg:justify-start">
                <svg
                  className="h-8"
                  viewBox="0 0 118 24"
                  fill="none"
